<?php
    ...
    class Umag_Categories_Widget extends WP_Widget
    {

        function __construct()
        {
            parent::__construct(
                'umag_categories_widget',
                esc_html__('# Umag Categories Widget', 'umag'),
    ...
    function register_umag_categories_widget()
    {
        register_widget('Umag_Categories_Widget');
    }

    add_action('widgets_init', 'register_umag_categories_widget');