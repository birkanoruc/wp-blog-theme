...
// Adds widget: # Umag Posts Widget
    class Umag_Video_Posts_Widget extends WP_Widget
    {

        function __construct()
        {
            parent::__construct(
                'umag_video_posts_widget',
                esc_html__('# Umag Video Posts Widget', 'umag'),
                array('description' => esc_html__('Display the videos according to the specified criteria.', 'umag'),) // Args
            );
        }
        ...
        public function widget($args, $instance)
        {
            ...
            if ($widget_query->have_posts()) {
                while ($widget_query->have_posts()) {
                    ...
                    get_template_part('template-parts/video-posts', 'widget');
                }
            } else {
    ...
    function umag_register_video_posts_widget()
    {
        register_widget('Umag_Video_Posts_Widget');
    }

    add_action('widgets_init', 'umag_register_video_posts_widget');